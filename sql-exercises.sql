...
VALUES ('LIMEE', 'WEEE INC.', 'Emil Juboori' , 'CEO', '2438 Dreden Pl', 'San Diego','CA','92037','USA','(858)775-4405','NA')

INSERT INTO Orders (CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry)
VALUES ('LIMEE','4','1996-07-03 00:00:00:000','1996-08-01 00:00:00:000','1996-07-16 00:00:00:000','2','69.69','Ernest Handel','101 W Broadway','Bern','CA','92101','USA')

INSERT INTO [Order Details] (OrderID,ProductID,UnitPrice,Quantity,Discount)
VALUES ('11078','6','25.00','10','1.00')
 
/* 18. Write a query to add yourself to the Customers table with an order for 'Grandma's Boysenberry Spread'. */

DELETE FROM Customers
Where CustomerID = 'LIMEE'
